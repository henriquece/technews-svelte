<script context="module" lang="ts">
	export type StoryWithVisibility = Story & { isVisible: boolean }
</script>
...
<script lang="ts">
	...
	export let story: StoryWithVisibility

	let loading = true
	let imageSrc = '/no-image.jpeg'
...
<a class:not-visible={!story.isVisible} href={story.url} target="_blank">
	<article>
